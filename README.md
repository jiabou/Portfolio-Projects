...
| **PROG7312 [Personal Project]** | Desktop app created for a muncipality that displays events, takes report and shows service request status. | C#, .NET | [View]() |
| **PROG7313 [Group Project]** | Android app for a montly budgeting with expense tracking. | Kotlin, Firebase | [View]() |
| **PROG7314 [Group Project]** | Adroid fitness app that tracks calories and shows different workouts. | Kotlin, Firebase, REST API | [View](https://github.com/jiabou/PROG7314.git) |
| **INSY7314 [Group Project]** | Web app for a worker and customer portal for security implementation. | C#, .NET, GitHub Actions | [View](https://github.com/Silver-Pond/INSY7314_PPOE_Part_2.git) |
