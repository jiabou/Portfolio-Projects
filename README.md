...
| **PROG7313** <br> [Team Project] | Android app for a montly budgeting with expense tracking. | Kotlin, Firebase | [View]() |
| **PROG7314** <br> [Team Project] | Adroid fitness app that tracks calories and shows different workouts. | Kotlin, Firebase, REST API | [View](https://github.com/jiabou/PROG7314.git) |
| **INSY7314** <br> [Team Project] | Web app for a worker and customer portal for security implementation. | C#, .NET, GitHub Actions | [View](https://github.com/Silver-Pond/INSY7314_PPOE_Part_2.git) |
| **INSY7315** <br> [Team Project] | Anroid app which is HustleHub, a platform created for students to become clients and providers. | Kotlin, Firebase, REST API, GitHub Actions | [View](https://github.com/st10258321/INSY7315.git) |
